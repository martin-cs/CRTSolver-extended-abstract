...
%
In the case of non-linear expressions over the theory of integers this
...
there is a decision procedure for Diophantine equations 
(a polynomial equation possessing only integer coefficients).
%
The MRDP \cite{LogicMattersMRDP} theorem gives a construction from recursively enumerable sets
to Diophantine equations, thus showing the undecideability of satisfiability.

This has an immediate practical consequence of there being no
